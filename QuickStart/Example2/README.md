...
cellbarcode="path/to/Example.cell_barcode_annotations.tsv"
sampleID="Tumor"
...
awk '!/INDEL|MultiAlleles|NonePASS_(commonSNP|gap|gnomAD|problem|repeat|rnaedit|segdup|PoN|fisherLB|NLB|sequencing)/ && /not_in_cluster/ && /Strong/' \
...
example scMutrace output can be downloaded from [here]()

![scMutrace](../../Figures/Example2/scMutrace.png)

**output of SComatic**:

example SComatic output can be downloaded from [here]()

![scMutrace](../../Figures/Example2/SComatic.png)
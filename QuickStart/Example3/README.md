...
1. Download raw bam file from [here](https://drive.google.com/file/d/1wj5KvYXc0uWIT9G2jnIbqSgfPaODyWyu/view?usp=drive_link) and processed file from [here](https://drive.google.com/file/d/1tKAw8q70_7QnN5RxvKf2GfEngUP_xAXI/view?usp=drive_link). You need to build index for this bam file using `samtools index chr20.maester_scRNA_CB.bam`.

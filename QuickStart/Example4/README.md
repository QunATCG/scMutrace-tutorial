...
- 1. Download scMutrace example from [here](https://drive.google.com/file/d/1Obb48s-IqQ6wxdYWINqCFWqY_X6uy-VQ/view?usp=drive_link)
...
# joint call
# Check paths in jointCall.contig before running the script

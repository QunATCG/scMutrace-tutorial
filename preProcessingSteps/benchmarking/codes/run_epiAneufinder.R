...
input <- "/cfs/klemming/home/q/qunli/qunl/Qun/callVariants/MousescRNAscATACWGS/scATAC/EPSRC2_scATAC/CNV/Matrix" #path to folder containing BAM files /or/ path+file_name for a TSV fragments file. If you want to test the package, sample data can be downloaded from the sample_data folder.

# Location of the output directory. If the directory does not exist it will be created
outdir <- "/cfs/klemming/home/q/qunli/qunl/Qun/callVariants/MousescRNAscATACWGS/scATAC/EPSRC2_scATAC/CNV/result/"
...
blacklist <- "/cfs/klemming/home/q/qunli/qunl/Qun/callVariants/MousescRNAscATACWGS/scATAC/EPSRC1_scATAC/CNV/mm10-blacklist.v2.bed" #Path and file name of the blacklisted regions in bed format. If you use hg38 genome then the blacklisted regions can be found in the sample_data folder.
...
title_karyo="Karyoplot of EPSRC2"

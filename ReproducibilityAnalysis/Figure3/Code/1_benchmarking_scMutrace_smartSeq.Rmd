...
# Benchmarking
```{r benchmarking}
data_benchmarking <- read.table("../Data/HumanNSCLC/data_benchmarking_NSCLC.txt", sep = "\t", header = T)
...
# GermlinePopulation
```{r population}
# data_populationData_NSCLC.rds was generated using https://github.com/QunATCG/scMutrace-tutorial/tree/main/AdvancedFunctions/PopulationGermline
data_population <- readRDS("../Data/HumanNSCLC/data_populationData_NSCLC.rds")
data_1kgenome_ann <- read.table("../Data/HumanNSCLC/1000genomeSampleInfo.txt", header = T, sep = "\t")

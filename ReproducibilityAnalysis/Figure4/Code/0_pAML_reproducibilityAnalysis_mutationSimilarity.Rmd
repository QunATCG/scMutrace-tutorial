...
cal_sigValSimilarity <- function(mut_list, iteration_times, sampleid){
  ...
  message(" 16")
  pair_16 <- unpaired_perm_test_viz(c(vals_RelLym_DxMye), c(vals_RelMye_RelLym))
...
pdf("heatmap_effect_size_1vsother.pdf", width = 5.8, height = 6)
...
cal_sigValSimilarity <- function(mut_list, iteration_times, sampleid){
  ...
  # permutation test
  message(" 31")
  pair_31 <- unpaired_perm_test_viz(c(vals_DxLym_RelMye), c(vals_RelLym_DxMye))
  pair_31_p <- pair_31$p_value
  pair_31_c <- pair_31$obs - median(pair_31$perm_distribution)
  
  message(" 32")
  pair_32 <- unpaired_perm_test_viz(c(vals_DxLym_RelMye), c(vals_RelMye_DxMye))
  pair_32_p <- pair_32$p_value
  pair_32_c <- pair_32$obs - median(pair_32$perm_distribution)
  
  message(" 34")
  pair_34 <- unpaired_perm_test_viz(c(vals_DxLym_RelMye), c(vals_DxLym_RelLym))
  pair_34_p <- pair_34$p_value
  pair_34_c <- pair_34$obs - median(pair_34$perm_distribution)
  
  message(" 35")
  pair_35 <- unpaired_perm_test_viz(c(vals_DxLym_RelMye), c(vals_DxMye_DxLym))
  pair_35_p <- pair_35$p_value
  pair_35_c <- pair_35$obs - median(pair_35$perm_distribution)
  
  message(" 36")
  pair_36 <- unpaired_perm_test_viz(c(vals_DxLym_RelMye), c(vals_RelMye_RelLym))
  pair_36_p <- pair_36$p_value
  pair_36_c <- pair_36$obs - median(pair_36$perm_distribution)
...
data_scRNA_sigSimilarity <- as.data.frame(matrix(data = 0, nrow = length(selected_samples_id), ncol = 10))
rownames(data_scRNA_sigSimilarity) <- selected_samples_id
colnames(data_scRNA_sigSimilarity) <- paste(c("pair_31_p", "pair_31_c", "pair_32_p", "pair_32_c",
                                        "pair_34_p", "pair_34_c", "pair_35_p", "pair_35_c",
                                        "pair_36_p", "pair_36_c"), "RNA", sep = "_")

# ATA
data_scATA_sigSimilarity <- as.data.frame(matrix(data = 0, nrow = length(selected_samples_id), ncol = 10))
rownames(data_scATA_sigSimilarity) <- selected_samples_id
colnames(data_scATA_sigSimilarity) <- paste(c("pair_31_p", "pair_31_c", "pair_32_p", "pair_32_c",
                                        "pair_34_p", "pair_34_c", "pair_35_p", "pair_35_c",
                                        "pair_36_p", "pair_36_c"), "ATA", sep = "_")
...
for (sampleid in selected_samples_id){
  ...
  message(paste0(sampleid, "-scATA"))
  r_scATA <- cal_sigValSimilarity(mut_cellTypeAnn_similarity_list_ATA_main, iteration_times, sampleid)
  data_scRNA_sigSimilarity[sampleid, "pair_31_p_RNA"] <- r_scRNA$pair_31_p
  data_scRNA_sigSimilarity[sampleid, "pair_31_c_RNA"] <- r_scRNA$pair_31_c
  data_scRNA_sigSimilarity[sampleid, "pair_32_p_RNA"] <- r_scRNA$pair_32_p
  data_scRNA_sigSimilarity[sampleid, "pair_32_c_RNA"] <- r_scRNA$pair_32_c
  data_scRNA_sigSimilarity[sampleid, "pair_34_p_RNA"] <- r_scRNA$pair_34_p
  data_scRNA_sigSimilarity[sampleid, "pair_34_c_RNA"] <- r_scRNA$pair_34_c
  data_scRNA_sigSimilarity[sampleid, "pair_35_p_RNA"] <- r_scRNA$pair_35_p
  data_scRNA_sigSimilarity[sampleid, "pair_35_c_RNA"] <- r_scRNA$pair_35_c
  data_scRNA_sigSimilarity[sampleid, "pair_36_p_RNA"] <- r_scRNA$pair_36_p
  data_scRNA_sigSimilarity[sampleid, "pair_36_c_RNA"] <- r_scRNA$pair_36_c
  
  
  data_scATA_sigSimilarity[sampleid, "pair_31_p_ATA"] <- r_scATA$pair_31_p
  data_scATA_sigSimilarity[sampleid, "pair_31_c_ATA"] <- r_scATA$pair_31_c
  data_scATA_sigSimilarity[sampleid, "pair_32_p_ATA"] <- r_scATA$pair_32_p
  data_scATA_sigSimilarity[sampleid, "pair_32_c_ATA"] <- r_scATA$pair_32_c
  data_scATA_sigSimilarity[sampleid, "pair_34_p_ATA"] <- r_scATA$pair_34_p
  data_scATA_sigSimilarity[sampleid, "pair_34_c_ATA"] <- r_scATA$pair_34_c
  data_scATA_sigSimilarity[sampleid, "pair_35_p_ATA"] <- r_scATA$pair_35_p
  data_scATA_sigSimilarity[sampleid, "pair_35_c_ATA"] <- r_scATA$pair_35_c
  data_scATA_sigSimilarity[sampleid, "pair_36_p_ATA"] <- r_scATA$pair_36_p
  data_scATA_sigSimilarity[sampleid, "pair_36_c_ATA"] <- r_scATA$pair_36_c
}
...
data_scRNA_scATA_sigSimilarity <- cbind(df_RNA[, c("pair_31_c_RNA", "pair_32_c_RNA", "pair_34_c_RNA", "pair_35_c_RNA", "pair_36_c_RNA")],
                                        df_ATA[, c("pair_31_c_ATA", "pair_32_c_ATA", "pair_34_c_ATA", "pair_35_c_ATA", "pair_36_c_ATA")])
...
pdf("heatmap_effect_size_3vsother.pdf", width = 5.8, height = 6)

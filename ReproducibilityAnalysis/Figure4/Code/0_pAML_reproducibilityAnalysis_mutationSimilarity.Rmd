...
paired_perm_test_viz <- function(x, y, n_perm = 10000) {
...
unpaired_perm_test_viz <- function(x, y, n_perm = 10000) {
...
for (p in pairs_RNA) {
  ...
  df_RNA[[c_col]][df_RNA[[p_col]] > 0.0001] <- NA
}
...
for (p in pairs_ATA) {
  ...
  df_ATA[[c_col]][df_ATA[[p_col]] > 0.0001] <- NA
}

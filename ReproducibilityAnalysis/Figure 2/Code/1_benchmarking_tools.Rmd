...
#data_benchmarking_humanColon_res$Tool <- factor(data_benchmarking_humanColon_res$Tool, levels = c("Strelka2", "freebayes", "SAMtools", "VarScan2", "scAllele", "Monopogen", "scMutrace"))
...
# data_benchmarking_cSCC_res$Tool <- factor(data_benchmarking_cSCC_res$Tool, levels = c("Strelka2", "freeBayes", "SAMtools", "VarScan2", "Monopogen", "SComatic", "scAllele", "scMutrace"))
...
#ggsave("../Figures/p_Mouse_scATAC_benchmarking_point.pdf", p_Mouse_scATAC_point, width = 4.47, height = 3.75)
#ggsave("../Figures/p_Mouse_scATAC_benchmarking_box.pdf", p_Mouse_scATAC_box, width = 4.47, height = 3.75)
```
...
#ggsave("../Figures/p_Mouse_scRNA_benchmarking_point.pdf", p_Mouse_scRNA_point, width = 4.47, height = 3.75)
